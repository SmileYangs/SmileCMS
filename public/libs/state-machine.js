(function (window) {
  ...
  var StateMachine = {
    ...
    enter: function(fsm, name, from, to, args) { return StateMachine.doCallback(fsm, fsm['onenter'],                       name, from, to, args); },
    before: function(fsm, name, from, to, args) { return StateMachine.doCallback(fsm, fsm['onbefore'],                       name, from, to, args); },
    ...
    buildEvent: function(name, map) {
      return function() {
		...
		StateMachine.before(fsm, name, from, to, args);
		StateMachine.enter(fsm, name, from, to, args);
